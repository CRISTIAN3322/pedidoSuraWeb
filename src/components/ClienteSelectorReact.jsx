...
function CarteraCliente({ cartera, totalCartera }) {
    return ( <
        ...
        .tabla-cartera-scroll {
          overflow-x: auto;
          border-radius: 10px;
          box-shadow: 0 2px 8px rgba(44, 82, 130, 0.08);
          background: #fff;
        }
        .tabla-cartera-moderna {
          width: 100%;
          border-collapse: collapse;
          min-width: 400px;
        }
        .tabla-cartera-moderna th, .tabla-cartera-moderna td {
          padding: 0.75rem 1rem;
          border-bottom: 1px solid #e2e8f0;
          text-align: left;
        }
        .tabla-cartera-moderna th {
          background: #f7fafc;
          color: #2d3748;
          font-weight: 600;
        }
        .tabla-cartera-moderna tbody tr:hover {
          background: #f7fafc;
        }
        .tabla-cartera-moderna tfoot {
          background: #f8f9fa;
        }
        .tabla-cartera-moderna tfoot td {
          font-weight: bold;
          color: #1a365d;
        }
        .tabla-cartera-moderna tr.dias-mayor-uno {
          background-color: #fff3cd !important;
        }
        .tabla-cartera-moderna tr.dias-mayor-diez {
          background-color: #f8d7da !important;
        }
        .tabla-cartera-moderna tr.dias-mayor-treinta {
